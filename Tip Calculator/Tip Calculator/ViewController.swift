...
class ViewController: UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    @IBAction func refreshButton(_ sender: UIButton) {
        startScan()
        sender.setTitle("Refeshing...", for: .normal)
    ...
    @IBAction func submit(_ sender: UIButton) {
        var tip = Double(numInput.text!) ?? 0
        tip = tip * 0.15
        outputText.text = "Total Tip: \(tip)\n"
        //outputText.text = "Total Tip: \(tip.text!)\n"
        //let intVal1 = Int(val1) ?? 0
    }
    ...
    override func viewDidLoad() {
        ...
        addDoneButtonOnNumpad(textField:numInput)
